...
{
    public sealed class VanguardDirectionCapture
    {
        private const string Output = "ArtDirection/2026-09-17/vanguard-directions-01/";
        ...
        public IEnumerator CaptureActualMovementAndAttacks()
        {
            ...
            foreach (string id in new[] { "sword", "weapon_staff", "weapon_daggers" })
            {
                ...
                foreach (var direction in new[] { new Vector2(1,1),new Vector2(-1,1),new Vector2(1,-1),new Vector2(-1,-1) })
                {
                    ...
                    _look.transform.position=Vector3.zero;
                    move.Hold(direction);
