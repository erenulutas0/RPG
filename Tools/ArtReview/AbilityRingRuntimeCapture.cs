...
{
    public sealed class AbilityRingRuntimeCapture
    {
        private const string Output = "ArtDirection/2026-09-19/ability-ring-runtime-01/";
        ...
        [UnityTest]
        public IEnumerator CaptureAbilityRingRuntime()
        {
            TestProfile.Begin();
