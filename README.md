...
Implemented: automatic combat, kill → XP, upgrade choice, Grunt/Runner/Tank archetypes, enemy attacks with hero death, Descent floor 1 (rooms and waves, forge, elite, enraging boss), gold with an Extract/Descend checkpoint, floor 2 with a scaling tier and modifier, victory/extracted/defeat results and one-tap restart, the Forge meta layer with a versioned local save and two relics. More weapon behaviors, analytics and a progress reset are subsequent work.
